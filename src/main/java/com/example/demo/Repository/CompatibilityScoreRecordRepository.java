...
public interface CompatibilityScoreRecordRepository
    ...
    findByStudentAIdOrStudentBIdOrderByScoreDesc(Long studentAId, Long studentBId);

    Optional<CompatibilityScoreRecord>
    findFirstByStudentAIdAndStudentBIdOrderByCreatedAtDesc(Long studentAId, Long studentBId);
